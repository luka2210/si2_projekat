...
public class Doktorski extends Knjiga {
	private Autor autor;
	private ArrayList<Mentor> mentori;
	
	public Doktorski(ResultSet knjiga, ResultSet autor, ResultSet mentori) throws SQLException {
		super(knjiga);
